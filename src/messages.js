const messages = {
  en: {
    ...
    'gateway.cloud.info': 'Information',
    'gateway.cloud.info.gateway.name': 'Name',
    'gateway.cloud.info.gateway.description': 'Description',
    'gateway.cloud.info.user': 'User',
    'gateway.cloud.info.gateway.id': 'Id',
  ...
  ru: {
    ...
    'gateway.cloud.info': 'Информация',
    'gateway.cloud.info.gateway.name': 'Название',
    'gateway.cloud.info.gateway.description': 'Описание',
    ...
    'device.info.platform': 'Платформа',
